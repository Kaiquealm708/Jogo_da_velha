...
let mesC = document.querySelector('#message');
...
function Check() {
  ...
  function declareWinner(winner) {
    ...
    mesC.classList.remove('hide')
  }

  //esconder msg
  setTimeout(function () {
    mesC.classList.add('hide');
  }, 3000);

  player1 = 0;
 player2 = 0;
  //zerar o tabuleiro
  let boxesRem = document.querySelectorAll('.box div');

  for (let i = 0; i < boxesRem.length; i++) {
    boxesRem[i].parentNode.removeChild(boxesRem[i]);
  }
